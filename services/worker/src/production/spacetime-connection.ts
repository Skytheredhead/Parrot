...
const VIEW_ACCESSORS: Readonly<Record<SpacetimeWorkerView, string>> = Object.freeze({
  pending_outbox_work: "pending_outbox_work",
  pending_post_search_documents: "pending_post_search_documents",
  pending_workspace_export_plans: "pending_workspace_export_plans",
  pending_workspace_export_cleanup_plans: "pending_workspace_export_cleanup_plans",
  pending_notification_delivery_plans: "pending_notification_delivery_plans",
  pending_notification_digest_schedules: "pending_notification_digest_schedules",
  pending_notification_digest_plans: "pending_notification_digest_plans",
  file_processing_plans: "file_processing_plans",
  agent_work_queue: "agent_work_queue",
  agent_context_candidates: "agent_context_candidates",
  service_agent_execution_plans: "service_agent_execution_plans",
  service_agent_run_progress: "service_agent_run_progress",
  service_agent_provider_dispatches: "service_agent_provider_dispatches",
  service_worker_effects: "service_worker_effects",
  service_agent_approval_bindings: "service_agent_approval_bindings",
  service_file_deletion_claims: "service_file_deletion_claims",
  service_file_processing_outcomes: "service_file_processing_outcomes",
});
